 ...
 */
package com.github.naoghuman.app.grid.drawing.validator;

import java.util.Objects;

/**
 * This class contains different general validation methods in context from this
 * application.
 *
 ...
 * @author  Naoghuman
 */
public class DefaultGridDrawingValidator {
    ...
    /**
     * Validates if the attribute {@code value} isn't {@code NULL} and not
     * {@code EMPTY}.
     *
     * @param   value the attribute which should be validated.
